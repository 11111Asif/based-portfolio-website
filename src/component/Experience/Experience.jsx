...
const Experience = () => {
    return (
        <div className="lg:px-24 px-4 bg-black py-12">
            <h1 className="text-4xl text-center text-white">My <span className="font-bold">Experience</span></h1>
            <div className='lg:w-full lg:h-[192px] w-[344px] h-[426px] mt-8 space-y-5 rounded-md px-8 py-7 border-2 border-[#71717A]'>
            ...
            <div className='lg:w-full lg:h-[192px] w-[344px] h-[426px] bg-[#27272A] mt-8 space-y-5 rounded-md px-8 py-7 border-2 border-[#71717A]'>
                <div className='lg:flex justify-between'>
                    <div className='flex gap-3'>
                        <img src={youtube} alt="" />
