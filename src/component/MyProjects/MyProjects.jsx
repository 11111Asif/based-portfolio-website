                ...
                <div className="hero ">
                    <div className="hero-content flex-col px-4 lg:flex-row">
                        ...
                        <div>
                            ...
                            <h3 className="text-2xl font-bold text-white mt-3">Crypto Screener Application</h3>
                ...
                <div className="hero">
                    <div className="hero-content flex-col lg:flex-row-reverse">
                        ...
                        <div>
                            ...
                            <h3 className="text-2xl font-bold text-white mt-3">Euphoria - Ecommerce (Apparels) Website Template</h3>
                            <p className="py-6 text-[#71717A]">
                                I'm Evren Shah Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to specimen book.
